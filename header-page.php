...
<!--<![endif]-->
<head>
	<link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,700italic|Expletus+Sans' rel='stylesheet' type='text/css'>
			...
			<div id="header-interno" class="interno">
				...
				<nav id="main-navigation" class="navbar navbar-default" role="navigation">
					...
					<div id="social">
						...
						<a target=_blank  href="https://www.facebook.com/cinepixproducoes?fref=ts" ><?php  require_once("wp-content/themes/cinepix-tema/assets/svg/facebook.svg");?> </a>
						<a target=_blank  href="https://www.youtube.com/user/cinepixproducoes" ><?php  require_once("wp-content/themes/cinepix-tema/assets/svg/youtube.svg");?> </a>
						<a target=_blank  href="https://twitter.com/cinepixeventos" ><?php 	require_once("wp-content/themes/cinepix-tema/assets/svg/twitter.svg"); ?> </a>
					<a target=_blank  href="	https://vimeo.com/cinepix" ><?php 	require_once("wp-content/themes/cinepix-tema/assets/svg/vimeo.svg"); ?> </a>
